...
export default async function ForrasokPage() {
  ...
  return (<><Link className="sh-back" href="/cms/forras-attekintes">‹ Forrásáttekintés</Link><h1 className="h1">Klinikai források</h1><p className="sub">Evidenciaforrások központi nyilvántartása: irányelvek, standardok, verziók és felülvizsgálati dátumok.</p><SourcesManager items={data ?? []} today={today} /></>)
}
